import { PageOrientation, BorderStyle, AlignmentType, VerticalAlign, convertMillimetersToTwip, ShadingType, LineRuleType, ImageRun, TextRun, ExternalHyperlink, WidthType, HeightRule, TableRow, TableCell, Paragraph, TableLayoutType, Table, Document, Header, Packer, Footer } from 'docx';
import tinycolor from 'tinycolor2';
import JSZip from 'jszip';
import { parse } from 'html-to-ast';
export { parse } from 'html-to-ast';
...
var calcMargin = function calcMargin(margin) {
  return convertMillimetersToTwip(10 * numberCM(margin));
};
...
var alignHandler = function alignHandler(_ref, styleOp) {
  var val = _ref.val;
  var styleOption = deepCopyByJSON(styleOp);
  styleOption.alignment = AlignMap[val] || AlignmentType.LEFT;
  return styleOption;
};
...
var textCreator = function textCreator(node, tagStyleMap) {
  ...
  return new TextRun(_extends({}, textBuildParam, styleOption));
};
  ...
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tableNode, tagStyleMap) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 44:
          c = _context.sent;
          texts.push(new Paragraph(_extends({
            children: c
        ...
        case 49:
          ...
          cellChildren.push(new TableCell(tableCellOptions));
        case 61:
          _context.next = 29;
          break;
        case 63:
  ...
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tableNode, tagStyleMap) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          return _context2.abrupt("return", new Table(tableParam));
        case 7:
        case "end":
          return _context2.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", new Paragraph(paragraphOption));
        case 13:
        ...
        case 16:
          ...
          return _context.abrupt("return", new Paragraph(_paragraphOption));
        case 21:
          if (!isTable) {
            _context.next = 28;
            break;
...
export { D_Layout, D_TagStyleMap, ElementCreator, StyleBuilder, chainStyle, exportAsDocx, exportAsZip, exportHtmlToDocx, exportMultiDocsAsZip, genDocument, getInnerTextNode, htmlToAST, tableNodeToITableOptions };
//# sourceMappingURL=editor-to-word.esm.js.map
